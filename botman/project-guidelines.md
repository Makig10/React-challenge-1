...
list of your recent bank transactions(HAVE LIST), among other features.
...
See a table of all transactions.(make A TABLE..table has 4rows)

 Fill out and submit the form to add a new transaction(HAVE A FORM FOR TRANSACTIONS). 
